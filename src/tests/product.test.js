...
test('POST /products/:id/images should set ProductImg', async () => {
  const newImage = await ProductImg
      .create({url: "http://localhost:8080/uploads/drone1.png", filename: "drone1.png"});
  const res = await request(app)
